                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="exampleInputPtitle">Product Title</label>
                                                    <input type="text" class="form-control" id="exampleInPtitle" placeholder="Product Title">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="exampleInputC1">Category</label>
                                                    <input type="text" class="form-control" id="exampleInC1" placeholder="Category">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleSelectUser">Users</label>
                                                        <select class="form-control" id="exampleSelectUser">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="Price" class="form-control" id="exampleInputPrice" placeholder="Price">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputGst">GST No.</label>
                                                        <input type="Gst" class="form-control" id="exampleInputGst" placeholder="GST no">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputUrl">Video URL</label>
                                                        <input type="url" class="form-control" id="exampleInputUrl" placeholder="Link">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
